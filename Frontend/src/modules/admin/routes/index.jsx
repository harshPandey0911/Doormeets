    ...
    <Suspense fallback={<LoadingFallback />}>
      <Routes>
        ...
        <Route path="/" element={
          ...
          <Route path="painting/pricing" element={<PaintingConfigPage defaultTab="pricing" />} />
          <Route path="painting/consultations" element={<PaintingConfigPage defaultTab="consultations" />} />
