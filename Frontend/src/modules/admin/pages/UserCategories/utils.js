...
export const ensureIds = (catalog) => {
  ...
  const withIds = {
    ...
    categories: (catalog.categories || []).map((c) => ({
      ...
      hasSubCategory: c.hasSubCategory ?? true,
      hasBrand: c.hasBrand ?? true,
      enableBrands: c.enableBrands || false,
      brandRequired: c.brandRequired || false,
      enableConsultantBooking: c.enableConsultantBooking || false,
