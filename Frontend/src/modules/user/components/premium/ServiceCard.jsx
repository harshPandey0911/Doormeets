            ...
            return (
              <>
                ...
                {showVisitsModal && createPortal(
                  ...
                  >
                    <div 
                      className="rounded-xl p-5 w-full max-w-sm shadow-2xl space-y-4 border animate-in fade-in zoom-in-95 duration-200"
                    ...
                    >
                      ...
                      <div className="space-y-3 py-1 max-h-[60vh] overflow-y-auto pr-1">
                        {visits.map((v, i) => (
                          <div key={i} className="flex gap-3 items-start p-3 rounded-xl border text-xs" style={{ backgroundColor: 'var(--background)', borderColor: 'var(--border)' }}>
                            <span className="w-2 h-2 rounded-full bg-indigo-500 mt-1.5 shrink-0" />
                            <div className="flex-1">
                              <div className="font-bold" style={{ color: 'var(--text-primary)' }}>Visit {v.sequence}</div>
                              <div className="mt-0.5 font-medium text-[11px]" style={{ color: 'var(--text-secondary)' }}>
