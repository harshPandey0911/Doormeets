...
const BottomCheckoutBar = ({ total, originalTotal, buttonText = 'Checkout', onClick, note = 'Inclusive of taxes and charges' }) => {
  return (
    <div className="fixed inset-x-0 bottom-[76px] lg:bottom-0 z-30 border-t border-gray-100 bg-white/95 px-4 pb-3 lg:pb-[calc(env(safe-area-inset-bottom)+12px)] pt-3 backdrop-blur-xl">
