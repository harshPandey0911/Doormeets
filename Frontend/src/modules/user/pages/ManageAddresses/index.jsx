  ...
  return (
    <div className="min-h-screen bg-light-bg pb-4">
      ...
      <main className="max-w-5xl mx-auto px-4 py-4">
        ...
        {/* Empty State */}
        {!loading && addresses.length === 0 && (
          <div className="py-10 text-center bg-card-bg rounded-md border-2 border-dashed border-border-color">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
          {addresses.map((address) => (
            <div
              ...
              className="bg-card-bg border border-border-color rounded-md p-4 relative"
            >
              {/* Menu Button */}
              <button
              ...
              {showMenu === (address._id || address.id) && (
                <div className="absolute top-12 right-4 bg-card-bg border border-border-color rounded-md shadow-lg z-10 min-w-[120px]">
                  <button
              ...
              <div className="pr-12">
                <div className="flex items-center gap-2 mb-2">
                  <span className="px-2 py-0.5 bg-gray-500/10 rounded-md text-xs font-bold uppercase text-secondary-text">
                    {address.type || 'HOME'}
                  </span>
                  {address.isDefault && (
                    <span className="px-2 py-0.5 bg-green-500/10 rounded-md text-xs font-bold uppercase text-green-700">
                      Default
                    </span>
                  )}
                </div>
