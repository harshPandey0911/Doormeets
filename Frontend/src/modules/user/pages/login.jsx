...
const Login = () => {
  ...
  return (
    <div className="min-h-[100dvh] bg-gray-50 flex flex-col justify-start sm:justify-center py-12 sm:px-6 lg:px-8 relative overflow-x-hidden">
      ...
      <div className="absolute bottom-[-10%] right-[-10%] w-[40%] h-[40%] bg-[#9E2E2A] opacity-[0.03] rounded-full blur-3xl animate-floating" style={{ animationDelay: '2s' }} />
      ...
      <div className="sm:mx-auto sm:w-full sm:max-w-md px-4 sm:px-0 relative z-10">
        <div className="bg-white py-8 px-4 shadow-2xl shadow-gray-200/50 sm:rounded-2xl sm:px-10 border border-gray-100 relative overflow-hidden animate-slide-in-bottom">
          <div className="absolute top-0 left-0 right-0 h-1.5 bg-gradient-to-r from-[#B33A35] via-[#9E2E2A] to-[#D56C67]" />
            ...
            <form className="space-y-6" onSubmit={handlePhoneSubmit}>
              <div className="animate-stagger-1 animate-fade-in">
                ...
                <div className="relative rounded-xl shadow-sm group">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none group-focus-within:text-[#B33A35] transition-colors">
                  ...
                  <input
                    ...
                    autoComplete="tel"
                    id="phone"
                    className="block w-full pl-24 pr-4 py-3.5 border-gray-300 rounded-xl focus:ring-[#B33A35] focus:border-[#B33A35] sm:text-sm transition-all duration-300 ease-in-out hover:border-gray-400"
              ...
              <div className="animate-stagger-2 animate-fade-in">
                <button
                  ...
                  className="group relative w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl text-sm font-bold text-white transition-all duration-500 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#B33A35] disabled:opacity-50 disabled:cursor-not-allowed hover:-translate-y-1 transform shadow-lg shadow-[#B33A35]/30 hover:shadow-[#B33A35]/40 overflow-hidden"
              ...
              <div className="mt-6 animate-stagger-3 animate-fade-in">
                ...
                <div className="mt-6">
                  <Link
                    to="/user/signup"
                    className="w-full inline-flex justify-center py-3 px-4 rounded-xl shadow-sm bg-white text-sm font-medium text-gray-500 hover:text-[#B33A35] hover:bg-gray-50 border border-gray-200 transition-all duration-300 hover:border-[#B33A35]/30"
                  >
                    Create an account
                  </Link>
                </div>
            ...
            <form className="space-y-6" onSubmit={handleOtpSubmit}>
              <div className="flex justify-center gap-2 sm:gap-3 py-4 animate-stagger-1 animate-fade-in">
                {otp.map((digit, index) => (
                  <input
                    ...
                    className="w-11 h-12 sm:w-12 sm:h-14 text-center text-xl sm:text-2xl font-bold border-gray-300 rounded-xl focus:ring-[#B33A35] focus:border-[#B33A35] placeholder-[#B33A35] transition-all duration-300 shadow-sm border focus:-translate-y-1 hover:border-gray-400"
              ...
              <div className="flex items-center justify-between text-sm animate-stagger-2 animate-fade-in">
                <button
                  ...
                  className="flex items-center font-medium text-gray-600 hover:text-[#B33A35] transition-colors"
                >
                ...
                <button
                  ...
                  className="font-medium text-[#B33A35] hover:text-[#9E2E2A] transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
                >
                  {resendTimer > 0
              ...
              <div className="animate-stagger-3 animate-fade-in">
                <button
                  ...
                  className="group relative w-full flex justify-center py-3.5 px-4 border border-transparent rounded-xl text-sm font-bold text-white transition-all duration-500 ease-in-out focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-[#B33A35] disabled:opacity-50 disabled:cursor-not-allowed shadow-lg shadow-[#B33A35]/30 hover:shadow-[#B33A35]/40 hover:-translate-y-1 transform overflow-hidden"
                  style={{ backgroundColor: brandColor }}
                >
                  <span className="absolute inset-0 w-full h-full bg-white/10 group-hover:translate-x-full transition-transform duration-700 -translate-x-full" />
                  {isLoading ? (
