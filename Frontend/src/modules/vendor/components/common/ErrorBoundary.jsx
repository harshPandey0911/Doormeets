      ...
      return (
        <div className="flex items-center justify-center min-h-screen" style={{ background: 'linear-gradient(135deg, #FCD34D 0%, #FDE68A 50%, #FFFFFF 100%)' }}>
          <div className="flex flex-col items-center gap-4 p-6 max-w-md mx-auto">
            ...
            {this.state.error && (
              <details open className="mt-4 p-4 bg-red-50 rounded-lg max-w-full overflow-auto w-full border border-red-250">
                <summary className="cursor-pointer font-semibold text-red-800 mb-2">Error Details</summary>
