...
exports.updateSettings = async (req, res, next) => {
  try {
    const {
      ...
      twitterUrl, instagramUrl, youtubeUrl, linkedinUrl,
      // Booking Timing
