  ...
  try {
    ...
    res.status(200).json({
      ...
      worker: {
        ...
        currentAvailability: worker.currentAvailability || 'OFFLINE',
        ...
        currentLevel: worker.currentLevel || 'L3',
        performanceScore: worker.performanceScore || 100,
        trustScore: worker.trustScore || 100,
        cancellationRate: worker.cancellationRate || 0,
        completionRate: worker.completionRate || 0,
        isFrozen: worker.isFrozen || false,
        freezeReason: worker.freezeReason,
        trainingCompleted: worker.trainingCompleted || false,
        activeBookingId: worker.activeBookingId,
