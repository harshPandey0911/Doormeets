...
const connectDB = async () => {
  try {
    const conn = await mongoose.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/Doormeets');
...
const seedVendors = async () => {
  try {
    ...
    const vendorsData = [
      {
        name: 'Rajesh Kumar',
        email: 'rajesh.kumar@doormeets.com',
        phone: '9876543210',
        password: 'vendor123',
      ...
      {
        name: 'Amit Sharma',
        email: 'amit.sharma@doormeets.com',
        phone: '9876543211',
        password: 'vendor123',
      ...
      {
        name: 'Vikram Singh',
        email: 'vikram.singh@doormeets.com',
        phone: '9876543212',
        password: 'vendor123',
    ...
    const workersData = [
      ...
      {
        name: 'Suresh Patel',
        email: 'suresh.patel@doormeets.com',
        phone: '9876543213',
        password: 'worker123',
      ...
      {
        name: 'Ravi Kumar',
        email: 'ravi.kumar@doormeets.com',
        phone: '9876543215',
        password: 'worker123',
      ...
      {
        name: 'Deepak Joshi',
        email: 'deepak.joshi@doormeets.com',
        phone: '9876543216',
        password: 'worker123',
      ...
      {
        name: 'Ankit Verma',
        email: 'ankit.verma@doormeets.com',
        phone: '9876543217',
        password: 'worker123',
        vendorId: createdVendors[2]._id,
